...
const Warehouse = () => {
  ...
  return (
    <div className='home-page container'>
      ...
      <UpdateWarehouseModal isOpen={isUpdateModalOpen} onClose={() => setIsUpdateModalOpen(false)} warehouseToEdit={warehouseToEdit} />
        ...
        <table class=" w-full text-sm text-left rtl:text-right">
          ...
          <tbody>
            ...
            {warehouses.map((warehouse, index) => (
              <tr key={warehouse._id} class=" border-blue-900 text-lg bg-white border-b">
                ...
                <td class="px-6 py-4 space-x-2 text-center">
                  <button onClick={() => handleUpdate(warehouse)}><FaEdit size={25} className='text-yellow-600 hover:text-yellow-500' /></button>
                  <button onClick={() => deleteWarehouse(warehouse._id)}><MdDelete size={25} className='text-red-600 hover:text-red-500' /></button>
                </td>
              </tr>
            ))}
